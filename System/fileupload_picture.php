<?php
	...
	$filename = basename($_FILES['student_image']['name']); //result = abc.jpg
	
	//step 2: get the file size
	$checkfilesize = $_FILES['student_image']['size'];
	...
	$destination = "img/student/".$filename; //follow the previous item name
