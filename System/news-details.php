...
<?php
	...
	if(!isset($_GET['id']))
	{
		echo "<script>alert('You have select the CONTENTS yet!')</script>";
		die("<script>window.location.href='news-list.php'</script>");
	}
?>
          ...
          <div class="col-md-8">
            <div class="single-news-p1-cont">
              ...
              <?php
              	...
              	$sql = "SELECT * FROM announcement INNER JOIN teacher ON announcement.teacher_id = teacher.teacher_id WHERE announcement.ann_id = '$id'";
              ...
              <div class="single-news-desc">
                ...
                <ul class="list-inline">
                  <li>Posted: <span class="text-theme-colored2"> <?php echo $rows['date_uploaded'] ?></span></li>
                  <li>By: <span class="text-theme-colored2"><?php echo $rows['teacher_fullname'] ?></span></li>
                </ul>
                <hr>
                <div class="bg-light-gray">
                  <p><?php echo $rows['ann_content'] ?></p>  
                </div>
              </div>
            </div>  
            <hr>
            ...
            <div class="ad-box-sn"> 
              <h3 class="pb-2">Notes</h3>
                <?php
					...
					$sql = "SELECT * FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id INNER JOIN chapter ON teacher.teacher_id = chapter.teacher_id WHERE student.student_id = '$id' ORDER BY chap_id LIMIT 3";
