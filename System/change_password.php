      ...
      <h3 style="text-align: center">Change Password</h3>
        <div class="row"> 
          <div class="col-md-10 main-login main-center">
              <form id="login-form" action="check_password.php" method="post">
                              <label for="password" style="float:left;font-size:x-large">Current Password</label> 
                              <input class="form-control" type="password" placeholder="Enter Current Password " required name="password" required>
                              <br/> 
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         <button type="submit" class="btn btn-general btn-white" style="float:left">Proceed</button>                                                   
                      </form>
          </div>
        </div>
      </div>
