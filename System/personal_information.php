...
<?php
	...
	{
		echo "<script>alert('PLEASE LOG IN FIRST BEFORE PROCEED')</script>";
            ...
            <div class="wrapper row">
              <div class="preview col-md-6"><br/><br/>
                ...
                ?>
                  ...
                  <div class="tab-pane active" id="pic-1"><img src="<?php echo $rows['student_photo'] ?>" /></div>
                  <br/><br/>
                  <label for="username">Classroom</label>
                  <input class="form-control" type="text" name="student_classroom" readonly value="<?php echo $rows['classroom_name'] ?>">
                  <br/>
                  <label for="username">Current Password</label>
                  <input class="form-control" type="password" required name="student_password" readonly value="<?php echo $rows['student_password'] ?>">
                  <br/>
                  ...
                  <button class="btn btn-general btn-white" onclick="window.location.href='change_password.php'">Change Password</button>
                  <br/><br/>
                </div>
              </div>
              <div class="details col-md-6">
               <div id="div-forms">
                      <form id="login-form" action="personal_information_update.php" method="post" enctype="multipart/form-data">
               		  ...
               		  ?>
                          ...
                          <div class="modal-body">
                              ...
                              <input class="form-control" type="text" placeholder="Enter Student ID " required name="student_id" value="<?php echo $rows['student_id'] ?>" readonly>
                              <br/> 
                              <label for="username">Fullname</label>
                              <input class="form-control" type="text" placeholder="Enter Fullname" required name="student_fullname" value="<?php echo $rows['student_fullname'] ?>">
                              <br/> 
                              <label for="username">NRIC</label>
                              <input class="form-control" type="text" placeholder="Enter NRIC" required name="student_ic" value="<?php echo $rows['student_ic'] ?>">
                              <br/> 
                              <label for="username">Email</label>
                              <input class="form-control" type="text" placeholder="Enter Email" required name="student_email" value="<?php echo $rows['student_email'] ?>">
                              <br/> 
                              <label for="username">Username</label>
                              <input class="form-control" type="text" placeholder="Enter Username" required name="student_username" value="<?php echo $rows['student_username'] ?>">
                              <br/> 
                              <label for="username">Change Profile Picture</label>
                 			  <input class="form-control" type="file" name="student_image" required >
                          </div>
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  <button type="submit" class="btn btn-general btn-white" style="width:80%; height: 80%">Update</button>                      
