     ...
     <section id="career-p3">
       <div class="container-fluide">
         <div class="row career-p3-title">
          <div class="col-md-12">
           <h3 class="wow fadeInUp text-center">Please Select The Chapter's Quiz</h3>
          </div> 
         </div>
         ...
         <?php
         	...
         	$sql = "SELECT * FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id INNER JOIN chapter ON teacher.teacher_id = chapter.teacher_id INNER JOIN quiz_question ON chapter.chap_id = quiz_question.chap_id WHERE student.student_id = '$s_id' GROUP BY chapter.chapter";
         ...
         ?>
           ...
           <div class="col-md-3 col-sm-6">
             ...
             <?php
               ...
               echo "<i class='fa fa-paper-plane-o' onclick=\"window.location.href='tutorial_questions.php?id=".$rows['question_id']."'\"></i>";
               
            ?>
               <h5>Chapter <?php echo $rows['chapter'] ?></h5>
             </div>
           </div>
