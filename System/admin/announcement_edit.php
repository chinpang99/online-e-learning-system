...
<?php
	...
	{
		echo "<script>alert('PLEASE CHOOSE THE ANNOUNCEMENT THAT YOU WOULD LIKE TO EDIT')</script>";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <form method="post" action="announcement_update.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                
                                
                                    <div class="form-group">
                                        <label for="ClassroomName">Announcement Title</label>
                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter title" name="ann_title" value="<?php echo $rows['ann_name'] ?>">&nbsp;
                                        <input type="hidden" value="<?php echo $rows['ann_id']?>" name="ann_id">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea">Announcement Content</label>
                                        <textarea class="form-control" rows="10" name="ann_content"><?php echo $rows['ann_content'] ?></textarea>
                                    </div>
                                </div>
                                    <div class="form-group">
                                        <label for="exampleInputFile">Announcement Picture</label>
                                        <input type="file" class="form-control-file" aria-describedby="fileHelp" name="ann_picture">
                                    </div>
                            </div> 
                            <button type="submit" class="btn btn-general btn-blue mr-2">Update</button>  
                            <button type="reset" class="btn btn-general btn-white" onclick="window.location.href='announcement_view.php'">Cancel</button>
                        </form>
