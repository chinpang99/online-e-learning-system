...
<head>
    ...
    <title>Search Supplementary Materials</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="supplementarymaterial_update.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <?php
                            	...
                            	$sql = "SELECT * FROM chapter INNER JOIN supplementary_material ON chapter.chap_id = supplementary_material.chap_id INNER JOIN supplementary_material_type ON supplementary_material.supp_no = supplementary_material_type.supp_no WHERE supplementary_material.supp_id = '$id'";
                            ...
                            ?>
                                <div class="col-md-6">
                                <input type="hidden" value="<?php echo $rows['supp_id'] ?>" name="id">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Supplementary Material Name</label>
                                        <input type="text" class="form-control" id="suppleName" placeholder="Enter file name" name="name" value="<?php echo $rows['supp_name'] ?>">
                                    </div>                                    
                                    <fieldset class="form-group">
                                        <legend>File Type</legend>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="material" id="optionsRadios1" <?php if($rows['supp_type'] == 'Notes') echo "checked";?> value="Notes"> Notes
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="material" id="optionsRadios2" <?php if($rows['supp_type'] == 'Tutorial') echo "checked";?> value="Tutorial"> Tutorial
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="material" id="optionsRadios2" <?php if($rows['supp_type'] == 'KB Notes') echo "checked";?> value="KB Notes"> KB Notes
                                            </label>
                                        </div> 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        	...
                                        	$sql_chap = "SELECT * FROM chapter WHERE teacher_id = '$t_id' ORDER BY chapter;";
                                        	
                                        	$query_chap = mysqli_query($conn, $sql_chap);
                                        	
                                        	while($rows_chap = mysqli_fetch_array($query_chap))
                                        	{
                                        
                                        ?>
                                            <option><?php echo $rows_chap['chapter'] ?> </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" id="fileupload" name="material_file" required="required">
                                        <small id="fileHelp" class="form-text text-muted">The document must not exceed 50 MB and must be in a correct file format.</small>
                                    </div>
                                 </div>
                            ...
                            <button type="reset" class="btn btn-general btn-white" onclick="window.history.go(-1)">Cancel</button>
                        </form>
                    </div>
