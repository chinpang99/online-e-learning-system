<?php
	...
	$filename = basename($_FILES['portfolio']['name']); //result = abc.jpg
	
	//step 2: get the file size
	$checkfilesize = $_FILES['portfolio']['size'];
	...
	$destination = "../User/louise/".$filename; //follow the previous item name
	...
	if(!move_uploaded_file($_FILES['portfolio']['tmp_name'], $destination))
	{
