                ...
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        <div class="card-header">
                            <h3>View Students Grade</h3>
                        </div>
                        <br>
                        <form method="post" action="student_performancee.php">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleSelect1">Please Select Chapter of Quiz</label>
                                    ...
                                    <?php
                                    	...
                                    	$sql = "SELECT * FROM chapter INNER JOIN teacher ON chapter.teacher_id = teacher.teacher_id WHERE teacher.teacher_id = '$id' ORDER BY chapter";
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleSelect1">Please Select Classroom</label>
                                    ...
                                    <?php
                                    	...
                                    	$sql = "SELECT * FROM classroom INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id WHERE teacher.teacher_id = '$id'";
                                    ...
                                    ?>
                                            ...
                                            <option><?php echo $rows['classroom_name'] ?></option>
                                    <?php
                                    	}
                                    ?>
                                        </select>
