            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="createe_chapter.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Chapter Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Chapter Name" name="name">
                                    </div>                                          
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ChapSelect">Chapters</label>
                                        <input type="number" class="form-control" placeholder="Enter Chapter" name="chapter">
                                    </div>
                                 </div>
                            </div> 
