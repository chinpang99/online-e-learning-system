            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="manage_quiz_update.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <?php
									...
									$sql = "SELECT * FROM chapter INNER JOIN quiz_question ON chapter.chap_id = quiz_question.chap_id WHERE quiz_question.question_id = '$id'";
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Chapter Name" name="a" value="<?php echo $rows['chapter'] ?>" readonly>
                                        <input type="hidden" value="<?php echo $rows['chap_id'] ?>" name="chap_id">
                                    </div>   
                                 </div>
								 ...
								 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="question" value="<?php echo $rows['questions'] ?>">
                                    </div>                                          
                                </div>
                                ...
                                <?php
									...
									$sql = "SELECT *, COUNT(quiz_selection.selection_id) FROM chapter INNER JOIN quiz_question ON chapter.chap_id = quiz_question.chap_id INNER JOIN quiz_selection ON quiz_question.question_id = quiz_question.question_id WHERE chapter.teacher_id = '$t_id' AND quiz_selection.question_id = '$id' GROUP BY quiz_selection.selection_id";
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $a ?></label>
                                        <input type="hidden" value="<?php echo $_GET['id'] ?>" name="ques_id">
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="<?php echo $b ?>" value="<?php echo $rows['answer_description'] ?>">
                                        <input type="radio" name="sel_id" style="float:left; margin-top:1%;margin-left:45%" value="<?php echo $rows['selection_id'] ?>" <?php if($rows['true_answer'] == 'True'){ echo "checked='checked'";} ?>> True
                                    </div>                                          
                                </div>
