                        ...
                        <div class="tab" role="tabpanel"> 
                            ...
                            <form action="check_password.php" method="post">
                              <div role="tabpanel" class="tab-pane fade show active" id="profilee">
                                    <div class="row mt-3">
                                        <h5 class="col-12 mb-2">Current Password</h5>
                                        <div class="col-6">                                                                                        
                                             <div class="form-group row">
			                                        <input type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Current Password" style="width:100%;" name="password">                                                                                       
                                            </div> 
                                        </div>
                                        <div class="col-6">
			                              <button type="submit" class="btn btn-outline-info" style="border-radius: 0%;cursor:pointer; width:100%; height:70%">Update</button> 
                                        </div>
                                    </div>
                              </div>
