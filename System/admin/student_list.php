        ...
        <div class="content-inner chart-cont">
            ...
            <!--***** CONTENT *****-->     
                ...
                <div class="row">
                    <div class="col-md-12">
                        <center>
                        <input type="text" placeholder="Search here..." size="150%" style="height:40px; padding-left: 1%" name="search">
                        <button class="btn btn-info" style="padding-left:30px;padding-right:30px;padding-top:5px;padding-bottom:5px;height:40px; margin-bottom:0.2%" type="submit">Search</button>
                        </center>
                    </div>
                </div><br/><br/>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Students List</strong></h3>
                            </div>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="bg-info text-white">
                                                ...
                                                <td class="text-center"><strong>Student IC</strong></td>
                                        ...
                                        <?php
                                        	...
                                        	if(isset($_POST['search']))
                                        	{
	                                        	...
	                                        	$sql = "SELECT * FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id WHERE classroom.teacher_id = '$id' AND (student.student_fullname LIKE '%$searchkey%' OR student.student_ic LIKE '%$searchkey%' OR student.student_email LIKE '%$searchkey%' OR student.student_username LIKE '%$searchkey%')";
                                        ...
                                        <tbody> 
                                            <?php
                                                ...
                                                echo "<td onclick=\"window.location.href= 'student_information.php?id=".$rows['student_id']."'\">".$rows['student_id']."</td>";
                                                echo "<td onclick=\"window.location.href= 'student_information.php?id=".$rows['student_id']."'\" class='text-center'>".$rows['student_fullname']."</td>";
                                                echo "<td onclick=\"window.location.href= 'student_information.php?id=".$rows['student_id']."'\" class='text-center'>".$rows['student_ic']."</td>";
                                                echo "<td onclick=\"window.location.href= 'student_information.php?id=".$rows['student_id']."'\" class='text-center'>".$rows['student_email']."</td>";
                                                echo "<td onclick=\"window.location.href= 'student_information.php?id=".$rows['student_id']."'\" class='text-center'>".$rows['classroom_name']."</td>";
                                                if($rows['status'] == 'Enable')
                                                {
                                             		echo "<td class='text-center'><button type='button' class='btn btn-outline-danger' style='width:70%; height:5%;margin-left: 25%;cursor:pointer' onclick=\"window.location.href='student_status.php?id=".$rows['student_id']."'\">Disable</button></td>";
                                             	}
                                           	...
                                           	}else
                                           	{
	                                        	...
	                                        	$sql = "SELECT * FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id WHERE classroom.teacher_id = '$id'";
