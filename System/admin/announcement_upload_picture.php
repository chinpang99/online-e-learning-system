<?php
	...
	$filename = basename($_FILES['ann_picture']['name']); //result = abc.jpg
	
	//step 2: get the file size
	$checkfilesize = $_FILES['ann_picture']['size'];
	...
	$destination = "../img/event".$filename; //follow the previous item name
	...
	if(!move_uploaded_file($_FILES['ann_picture']['tmp_name'], $destination))
	{
