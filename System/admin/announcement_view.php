    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner chart-cont">
            ...
            <!--***** CONTENT *****-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" placeholder="Search announcement content here...." size="150%" style="height:40px; padding-left: 1%" name="search">
                        <button class="btn btn-info" style="padding-left:23px;padding-right:23px;padding-top:5px;padding-bottom:5px;height:40px; margin-bottom:0.2%" type="submit">Search</button>
                    </div>
                </div><br/><br/>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                  	<?php
                  		...
                  		$sql = "SELECT * FROM announcement INNER JOIN teacher ON announcement.teacher_id = teacher.teacher_id WHERE announcement.teacher_id = '$id' ";
                    ...
                    <tr>
                      ...
                      <?php
                      	...
                      	echo "<td class='text-center'><button type='button' class='btn btn-outline-success' style='width:100%; height:5%; margin-left: 25%;cursor:pointer' onclick=\"window.location.href='announcement_edit.php?id=".$rows['ann_id']."'\">Edit</button></td>";
                      	echo "<td class='text-center'><button type='button' class='btn btn-outline-danger' style='width:90%; height:5%; margin-left: 25%;cursor:pointer' onclick=\"window.location.href='announcement_delete.php?id=".$rows['ann_id']."'\">Delete</button></td>";
                      ?>
                    </tr>
