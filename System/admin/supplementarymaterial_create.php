            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="supplementarymaterial_createe.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Supplementary Material Name</label>
                                        <input type="text" class="form-control" id="suppleName" placeholder="Enter file name" name="name">
                                    </div>                                    
                                    <fieldset class="form-group">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="material" id="false" value="<?php echo $rows['supp_type'] ?>"> <?php echo $rows['supp_type'] ?>
                                            </label>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" id="fileupload" name="material_file">
                                        <small id="fileHelp" class="form-text text-muted">The document must not exceed 10 MB and must be in a correct file format.</small>
                                    </div>
                                 </div>
                            </div> 
