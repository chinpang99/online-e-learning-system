                    ...
                    <div class="card hovercard">
                        <div class="tab" role="tabpanel"> 
                            <ul class="nav nav-tabs" role="tablist">
                              <li class="nav-item ">
                                <a class="nav-link active" href="#profilee" role="tab" data-toggle="tab"><span><i class="fa fa-user"></i></span> Profile</a>
                              </li>
                              <li class="nav-item">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                <strong class="mr-5"><i class="fa fa-user"> Teacher ID: </i></strong>    <?php echo $rows['teacher_id'] ?>
                                            </div>
                                            <div class="form-group">
                                                <strong class="mr-5"><i class="fa fa-globe"> IC: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i></strong>   <?php echo $rows['teacher_ic'] ?>
                                            </div>
                                            <div class="form-group">
                                                <strong class="mr-5"><i class="fa fa-user"> Username: </i></strong>    <?php echo $rows['teacher_username'] ?>
                                            </div> 
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <strong class="mr-5"><i class="fa fa-globe"> Full Name: </i></strong><?php echo $rows['teacher_fullname'] ?>
                                            </div>
                                            <div class="form-group">
                                                <strong class="mr-5"><i class="fa fa-envelope"> Email: </i></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
                                                <?php echo $rows['teacher_email'] ?>
                                            </div>
                                        </div>
                                    </div>
                              </div>
                                    ...
                                    <div class="row mx-2">
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="<?php echo $rows['teacher_fullname'] ?>" id="example-text-input" name="fullname" required="required">
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                                <label for="example-email-input" style="width: 85px;" class=" col-form-label">Email</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="email" value="<?php echo $rows['teacher_email'] ?>" id="example-email-input" name="email" required="required">
                                                </div>
                                            </div>                                            
                                            <div class="form-group row">
                                                <label for="example-email-input" style="width: 85px;" class=" col-form-label">Profile Picture</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="file" id="example-email-input" name="photo" required="required">
                                                </div>
                                            </div> 
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label for="example-text-input" style="width: 85px;" class=" col-form-label">IC</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="<?php echo $rows['teacher_ic'] ?>" id="example-text-input" name="ic" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-date-input" style="width: 85px;" class=" col-form-label">Username</label>
                                                <div class="col-9">
                                                    <input class="form-control" type="text" value="<?php echo $rows['teacher_username'] ?>" id="example-date-input" name="username" required="required">
                                                </div>
                                            </div>
