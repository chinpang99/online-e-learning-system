            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="createe_quiz.php" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <?php
									...
									$sql = "SELECT *, COUNT(quiz_question.chap_id) AS 'a' FROM chapter INNER JOIN quiz_question ON chapter.chap_id = quiz_question.chap_id WHERE chapter.chapter = '$chap' AND chapter.teacher_id = '$t_id'";
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Chapter Name" name="a" value="<?php echo $chap ?>" readonly>
                                    </div>   
                                 </div>
                                 
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Quiz Number:</label>
                                        <input type="text" class="form-control" name="question" value="<?php echo $ii ?>" readonly>
                                    </div>                                          
                                </div>
                                ...
                                ?>
								 ...
								 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="question" required>
                                    </div>                                          
                                </div>
                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Selection A</label>
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="sel_a" required>
                                        <input type="radio" name="true" style="float:left; margin-top:1%;margin-left:45%" value="1" required> True
                                    </div>                                          
                                </div>
                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Selection B</label>
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="sel_b" required>
                                        <input type="radio" name="true" style="float:left; margin-top:1%;margin-left:45%" value="2" required> True
                                    </div>                                          
                                </div>
                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Selection C</label>
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="sel_c" required>
                                        <input type="radio" name="true" style="float:left; margin-top:1%;margin-left:45%" value="3" required> True
                                    </div>                                          
                                </div>
                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Selection D</label>
                                        <input type="text" class="form-control" placeholder="Enter Quiz Questions" name="sel_d" required>
                                        <input type="radio" name="true" style="float:left; margin-top:1%;margin-left:45%" value="4" required> True
                                    </div>                                          
                                </div>
