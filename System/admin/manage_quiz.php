                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="suppleName" placeholder="Enter file name" name="title" value="<?php echo $rows['chapter'] ?>" readonly>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                      <?php
		                ...
		                $sql = "SELECT *, COUNT(quiz_question.question_id) AS 'a' FROM chapter INNER JOIN quiz_question ON chapter.chap_id = quiz_question.chap_id WHERE chapter.teacher_id = '$t_id' AND chapter.chap_id = '$id' GROUP BY quiz_question.question_id";
                   ...
                   ?>
		                   ...
		                   <td class='text-center'><?php echo $rows['questions'] ?></td>
		                   
		                   	                      
		                      
		                      <?php
								
								echo "<td class='text-center'><button type='button' class='btn btn-outline-success' style='width:100%; height:5%; margin-left: 25%;cursor:pointer' onclick=\"window.location.href='manage_quiz_edit.php?id=".$rows['question_id']."'\">Edit</button></td>";
		                      	echo "<td><button type='button' class='btn btn-outline-danger' style='width:70%; height:5%; margin-left: 25%;cursor:pointer' onclick=\"window.location.href='manage_quiz_delete.php?id=".$rows['question_id']."'\">Delete</button></td>";
		                      ?>
