            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form action="create_quizz.php" method="post">
                            <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ChapSelect">Select <b>Chapter</b> to Create Quiz</label>                                        
                            ...
                            <button type="submit" class="btn btn-general btn-blue mr-2" style="width:20%;height:20%;margin-top:2.5%">Submit</button>  
                            <button type="reset" class="btn btn-general btn-white" style="width:20%;height:20%;margin-top:2.5%">Cancel</button>
