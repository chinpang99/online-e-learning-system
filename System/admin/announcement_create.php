            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card form" id="form1">
                        ...
                        <br>
                        <form method="post" action="announcement_createe.php" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="ClassroomName">Announcement Title</label>
                                        <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Enter title" name="ann_title">&nbsp;
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea">Announcement Content</label>
                                        <textarea class="form-control" rows="10" name="ann_content"></textarea>
                                    </div>
                                </div>
                                    <div class="form-group">
