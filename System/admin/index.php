...
<?php 
	...
	{
		echo "<script>alert('PLEASE LOG YOUR TEACHER ACCOUNT!')</script>";
...
======================================================-->
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            ...
            <div class="row" id="report1">
                <div class="col-sm-3">
                    <div class="card">
                        <div class="card-block card-header card-chart">
                            <div class="text-left report1-cont">
                                <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> 9,220</h2>
                                <span class="text-muted">Todays Registered</span>
                            </div>
                            <span class="text-success">80%</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 80%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-block card-header card-chart">
                            <div class="text-left report1-cont">
                                ...
                                <span class="text-muted">Number of View (Today)</span>
                            </div>
                            <span class="text-danger">43%</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" role="progressbar" style="width: 43%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p><small>Last month 10% Growth</small></p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-block card-header card-chart"> 
                            <div class="text-left report1-cont">
                                ...
                                <span class="text-muted">Total Number of Students </span>
                            </div>
                            <span class="text-warning">53%</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning" role="progressbar" style="width: 53%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p><small>Last month 10% Growth</small></p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-block card-header card-chart"> 
                            <div class="text-left report1-cont">
                                ...
                                <span class="text-muted">Total Number of Views</span>
                            </div>
                            <span class="text-info">70%</span>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 70%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <p><small>Last month 10% Growth</small></p>
                        </div>
                    </div>
            ...
            <div class="row" id="report2">
                <div class="col-md-6 mt-2">
                    <div class="card card-c1">
                        ...
                        <div class="card-footer">
                            <div class="stats" style="font-size:medium">
                ...
                <div class="col-md-4" style="margin-top: 2.5%">
                    <div class="card card-c2" style="width: 154%; height:96%">
                        <div class="dropdown pull-right menu-sett-card" > 
                            <a id="notifications" class="nav-link" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-ellipsis-v men"></i> 
                            </a>
                        ...
                        <div class="header">
                            <h4 class="title" style="text-transform:uppercase">Teacher's Announcement</h4>
                            <p class="category" style="margin-top:1%">Latest News Update</p>
                            <hr>
                        </div>
            ...
            <div class="row" id="report4">
                <div class="col-md-4 mt-0" id="card-2">
                    <div class="card hovercard">
                        ...
                        <div class="bottom">
                        	<a href="mailto:ben10chia@yahoo.com" class="btn-social btn-email" style="background-color:blue"><i class="fa fa-envelope"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mt-0" id="card-2">
                    <div class="card hovercard">
                        <div class="cardheader"></div>
                        <div class="avatar">
                            <img alt="" src="img/avatar-2.jpg" class="img-fluid">
                        </div>
                        <div class="info">
                            <div class="title">
                                <a target="_blank" href="#">Steena Ben</a>
    ...
    type: 'pie',
    data: {
      labels: [" A and above", " B - B+", " C - C+", "D", " E (Fail)"],
      datasets: [{
