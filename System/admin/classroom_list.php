            ...
            <!--***** CONTENT *****-->     
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <center>
                        <input type="text" placeholder="Insert Classroom Name..." size="150%" style="height:40px; padding-left: 1%" name="search">
                        <button class="btn btn-info" style="padding-left:30px;padding-right:30px;padding-top:0px;padding-bottom:0.5px;height:40px; margin-bottom:0.2%;
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Classroom List</strong></h3>
                            </div>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr class="bg-info text-white">
                                                <td><strong>Classroom ID</strong></td>
                                                <td class="text-center"><strong>Classroom Name</strong></td>
                                                <td class="text-center"><strong>Access Code</strong></td>
                                                <td class="text-center"><strong>Maximum Number of Students</strong></td>
                                                <td class="text-center"><strong>Current Number of Students</strong></td>
                                        ...
                                        <tbody>
                                          <?php
										  	...
										  	if(isset($_POST['search']))
											{
												...
												$sql = "SELECT *, COUNT(student.classroom_id) AS 'a' FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id WHERE classroom.classroom_name LIKE '%$searchkey%' AND classroom.teacher_id = '$id' GROUP BY classroom.classroom_id";
										  ...
										  ?>                                            
											  <tr>
	                                          <td style="padding-top:1.5%"><?php echo $rows['classroom_id'] ?></td>
	                                          <td class="text-center" style="padding-top:1.5%"><?php echo $rows['classroom_name'] ?></td>
	                                          <td class="text-center" style="padding-top:1.5%"><?php echo $rows['access_code'] ?></td>
	                                          <td class="text-center" style="padding-top:1.5%"><?php echo $rows['number_of_students'] ?></td>
	                                          <td class="text-center" style="padding-top:1.5%"><?php echo $rows['a'] ?></td>
	                                          <?php echo "<td class='text-center'><button type='button' class='btn btn-outline-success' style='height:5%; margin-left: 25%;cursor:pointer' onclick=\"window.location.href='classroom_create.php?id=".$rows['classroom_id']."'\">Edit</button></td>";?>	                                          
	                                          <td class="text-center"><button type="button" class="btn btn-outline-danger"style="height:5%; 
	                                          margin-left: 25%;cursor:pointer">Delete</button></td>
	                                          </tr>
                                          <?php
                                            	}
                                           }else{															
											//step 2: create the sql query for viewing the data from table
											$sql = "SELECT *, COUNT(student.classroom_id) AS 'a' FROM student INNER JOIN classroom ON student.classroom_id = classroom.classroom_id INNER JOIN teacher ON classroom.teacher_id = teacher.teacher_id WHERE classroom.teacher_id = '$id' GROUP BY classroom.classroom_id";	
										...
										?>
                                            <tr>
                                                <td style="padding-top:1.5%"><?php echo $rows['classroom_id'] ?></td>
                                                <?php 
                                                	echo "<td class='text-center' style='padding-top:1.5%;cursor:pointer;' onclick=\"window.location.href='classroom_student_list.php?id=".$rows['classroom_id']."'\">".$rows['classroom_name']." </td>";
                                                ?>
                                                <td class="text-center" style="padding-top:1.5%"><?php echo $rows['access_code'] ?></td>
                                                <td class="text-center" style="padding-top:1.5%"><?php echo $rows['number_of_students'] ?></td>
                                                <td class="text-center" style="padding-top:1.5%"><?php echo $rows['a'] ?></td>
